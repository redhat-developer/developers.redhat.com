...
undefined method `[]' for nil:NilClass
```
This is a current issue with the system [TODO]. If you get this error then please stop and then remove the docker containers. So, for each container id run
```
