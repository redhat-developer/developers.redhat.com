...
class RhamtFix extends AbstractMigration
{
  ...
  public function up() {
    ...
    $this->execute("UPDATE node__field_url_product_name SET field_url_product_name_value = 'rhamt' WHERE nid = 37375");
    $this->execute("UPDATE node_revision__field_url_product_name SET field_url_product_name_value = 'rhamt' WHERE nid = 37375");
  ...
  public function down() {
    ...
    $this->execute("UPDATE node__field_url_product_name SET field_url_product_name_value = 'rhamt-new' WHERE nid = 37375");
    $this->execute("UPDATE node_revision__field_url_product_name SET field_url_product_name_value = 'rhamt-new' WHERE nid = 37375");
