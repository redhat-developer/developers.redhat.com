...
class RemoveProdLinks extends AbstractMigration
{
    public function up() {
        ...
        $this->execute('UPDATE lightning_paragraph__field_overview_main_content set field_overview_main_content_value = REPLACE(field_overview_main_content_value,\'http://developer-drupal.web.prod.ext.phx2.redhat.com\', \'\')');
    }
}
