...
var RHDPSearchFilterGroup = /** @class */ (function (_super) {
    ...
    RHDPSearchFilterGroup.prototype.connectedCallback = function () {
        var _this = this;
        this.innerHTML = this.template(__makeTemplateObject(["", ""], ["", ""]), this.name);
        this.renderItems();
...
var RHDPSearchFilterItem = /** @class */ (function (_super) {
    ...
    Object.defineProperty(RHDPSearchFilterItem.prototype, "active", {
        ...
        set: function (val) {
            ...
            this.innerHTML = this.template(__makeTemplateObject(["", "", "", ""], ["", "", "", ""]), this.name, this.key, this.active);
    ...
    RHDPSearchFilterItem.prototype.connectedCallback = function () {
        var _this = this;
        if (this.inline) {
            this.innerHTML = this.inlineTemplate(__makeTemplateObject(["", ""], ["", ""]), this.name);
...
var RHDPSearchQuery = /** @class */ (function (_super) {
    ...
    RHDPSearchQuery.prototype.search = function (term) {
        ...
        fetch(this.urlTemplate(__makeTemplateObject(["", "", "", "", "", "", "", "", ""], ["", "", "", "", "", "", "", "", ""]), this.url, this.term, this.from, this.limit, this.sort, this.productString, this.tagString, this.sysTypeString))
            .then(function (resp) { return resp.json(); })
            .then(function (data) {
            _this.results = data;
        });
...
var RHDPSearchResultCount = /** @class */ (function (_super) {
    ...
    RHDPSearchResultCount.prototype.setText = function () {
        if (this.term.length > 0) {
            this.innerHTML = this.template(__makeTemplateObject(["", "", ""], ["", "", ""]), this.count, this.term);
        }
    };
...
var RHDPSearchResult = /** @class */ (function (_super) {
    ...
    RHDPSearchResult.prototype.renderResult = function () {
        this.innerHTML = this.template(__makeTemplateObject(["", "", "", "", "", "", "", ""], ["", "", "", "", "", "", "", ""]), this.url[0], this.url[1], this.title, this.kind, this.created, this.description, this.premium);
    };
