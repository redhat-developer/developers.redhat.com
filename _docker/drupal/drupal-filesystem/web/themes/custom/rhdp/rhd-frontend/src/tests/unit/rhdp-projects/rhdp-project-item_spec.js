...
describe('RHDP Project Items Component', function() {
    ...
    describe('innerHTML', function() {
        ...
        it('should have all attributes populated with text', function() {
            ...
            expect(projectsListHTML[0].innerHTML).toEqual('Docs: <a href="http://docsLink.com/">Documentation <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[1].innerHTML).toEqual('Community: <a href="http://communityLink.com/">communityLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[2].innerHTML).toEqual('Mailing List: <a href="http://mailingListLink.com/">mailingListLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[3].innerHTML).toEqual('Chat: <a href="http://chatLink.com/">chatLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[4].innerHTML).toEqual('JIRA: <a href="http://jiraLink.com/">jiraLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[5].innerHTML).toEqual('Source: <a href="http://srcLink.com/">srcLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[6].innerHTML).toEqual('Github: <a href="http://githubLink.com/">githubLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[7].innerHTML).toEqual('Build: <a href="http://buildLink.com/">buildLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[8].innerHTML).toEqual('Issue: <a href="http://issueTracker.com/">issueTracker.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[9].innerHTML).toEqual('User Forum: <a href="http://userForumLink.com/">userForumLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[10].innerHTML).toEqual('Dev Forum: <a href="http://devForumLink.com/">devForumLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[11].innerHTML).toEqual('KnowledgeBase: <a href="http://knowledgebaseLink.com/">knowledgebaseLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[12].innerHTML).toEqual('Blog: <a href="http://blogLink.com/">blogLink.com/ <i class="fas fa-external-link"></a>');
            expect(projectsListHTML[13].innerHTML).toEqual('Anonymous Source: <a href="http://anonymousLink.com/">anonymousLink.com/ <i class="fas fa-external-link"></a>');
