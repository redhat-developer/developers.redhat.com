        ...
        execute: function () {
            RHDPSearchSortPage = (function (_super) {
                ...
                function RHDPSearchSortPage() {
                    var _this = _super.call(this, RHDPSearchSortPage, { delayRender: true }) || this;
                    _this._sortChange = _this._sortChange.bind(_this);
                    return _this;
                }
                Object.defineProperty(RHDPSearchSortPage.prototype, "html", {
                    get: function () {
                ...
                Object.defineProperty(RHDPSearchSortPage, "tag", {
                    get: function () { return 'rhdp-search-sort-page'; },
                    enumerable: true,
                    configurable: true
                });
            ...
            pfelement_js_1.default.create(RHDPSearchSortPage);
        }
    };
});
