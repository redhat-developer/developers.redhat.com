...
define(["require", "exports", "@patternfly/pfelement/pfelement.umd"], function (require, exports, pfelement_umd_1) {
    ...
    pfelement_umd_1.default.create(DPSearchOneBox);
...
System.register(["../../@patternfly/pfelement/pfelement.js"], function (exports_1, context_1) {
    ...
    var pfelement_js_1, DPSearchOneBox, templateObject_1;
    ...
    return {
        ...
        execute: function () {
            DPSearchOneBox = (function (_super) {
                __extends(DPSearchOneBox, _super);
                function DPSearchOneBox(url) {
                    var _this = _super.call(this, DPSearchOneBox, { delayRender: true }) || this;
                    _this._term = '';
                    _this._url = '../rhdp-apps/onebox/onebox.json';
                    _this._mock = false;
            ...
            exports_1("default", DPSearchOneBox);
            pfelement_js_1.default.create(DPSearchOneBox);
        }
    };
