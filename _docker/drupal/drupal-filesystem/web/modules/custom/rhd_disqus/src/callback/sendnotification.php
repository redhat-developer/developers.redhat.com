...
$disqusApiSecret = 'dDlPQkXJbfE2dkvCE7ukDYQ4izyRDcYz6aa3ycwnCvAxQtuQDCFcOMHA5qlJBoAI'; 
...
$postAuthor = 'alistair@alt-media.co.uk'; 
...
echo 'Sent email to: ' . $postAuthor . " Post ID: " . $postId;
echo $subject;
echo $message;
?>