...
class TestOptions < Minitest::Test
  ...
  def test_acceptance_test_target_task
    ClimateControl.modify RHD_TEST_PROFILE: 'desktop', RHD_JS_DRIVER: 'docker_chrome', ACCEPTANCE_TEST_DESCRIPTION: 'Drupal:Desktop Acceptance Tests' do
      ...
      assert_equal('Drupal:Desktop Acceptance Tests', ENV['ACCEPTANCE_TEST_DESCRIPTION'])
