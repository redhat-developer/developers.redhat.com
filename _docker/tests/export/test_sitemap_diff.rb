...
class TestSitemapDiff < MiniTest::Test
  ...
  def test_list_differences_between_sitemaps
      ...
      developers_redhat_sitemap = build_mock_for_sitemap_request_to('https://developers.redhat.com/sitemap.xml', 'diff-sitemap-1.xml')
      ...
      expected_output = <<EOD
=== The following pages are in the sitemap of https://developers.redhat.com/sitemap.xml but not in the sitemap at http://docker/sitemap.xml: ===
- /articles/no-cost-rhel-faq
=== The following pages are in the sitemap at 'http://docker/sitemap.xml' but not in the https://developers.redhat.com/sitemap.xml sitemap: ===
- /foobar
EOD
