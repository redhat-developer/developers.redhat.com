...
class TestOptions < Test::Unit::TestCase
    ...
    def test_awestruct_command
      ...
      assert_equal(["--no-deps", "--rm", "--service-ports", "awestruct", "bundle exec rake create_pr_dirs[docker-pr,build,6] clean deploy[staging_docker_pr]"], tasks[:awestruct_command_args])
      tasks = Options.parse (["--run-the-stack"])
