...
Oracle JDK.
2.  Download link:#{site.products['devstudio'].downloads['8.1.0.GA'].assets[site.products['devstudio'].default_download_artifact_type].artifacts[0].url}[JBoss Developer Studio 8.1.0.GA #{site.products['devstudio'].downloads['8.1.0.GA'].assets[site.products['devstudio'].default_download_artifact_type].artifacts[0].name}]
