...
:awestruct-layout: developer-program
:awestruct-status: yellow
:awestruct-issues: [WAY-46]
:awestruct-description: Answers common questions about the Red Hat JBoss Developer Program

== Overview

=== Overview

The purpose of the Red Hat JBoss Developer program is to provide subscribers the best tools, content and assistance so that they can be as productive as possible with Red Hat JBoss middleware technologies.
...
The JBoss Developer Program is available for $0.  You will need to register, provide some minimal information and agree to the link:../terms-and-conditions[terms and conditions] of the program.

=== How do I get started?

1.  Create or update your account.
2.  Download link:../products/devstudio/overview/[JBoss Developer Studio].
3.  Check out the many quickstarts and tutorials listed in the link:../get-started[get started] section.
...
The link:../terms-and-conditions[terms and conditions] describe how the developer program subscription may be used.  The major difference between a full commercial Red Hat subscription and the Developer Program subscription is that the Red Hat JBoss Developer Program is intended for individual *developer-use* only.  Integration, test and production environments will require a paid subscription.

=== How do I get a commercial subscription?
