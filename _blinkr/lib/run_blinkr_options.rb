...
#
# Class implementation that parses the options supplied to the run-blinkr.rb script.
#
...
class RunBlinkrOptions
  ...
  #
  # Parses the command line supplied to the run-blinkr.rb wrapper script.
  #
  ...
  #
  # Builds the command that will be used to execute the broken link checks.
  #
