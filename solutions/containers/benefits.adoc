...
* link:https://developers.redhat.com/blog/2015/09/24/cant-we-just-run-boot2docker-in-production/[Can’t We Just Run Boot2Docker in Production?]
...
* link:https://developers.redhat.com/blog/2014/11/06/introducing-a-super-privileged-container-concept/[Introducing a _Super_ Privileged Container Concept]
