...
You will find tools to help you be productive including link:http://openjdk.java.net/[OpenJDK], performance tools such as link:http://icedtea.classpath.org/thermostat/[Thermostat], link:#{site.base_url}/products/eap[JBoss EAP], link:#{site.base_url}/products/openshift[OpenShift] cloud-based deployments, link:#{site.base_url}/products/datagrid/[data grid], link:#{site.base_url}/products/webserver[Apache HTTP and Tomcat], link:#{site.base_url}/products/fuse[integration solutions], link:#{site.base_url}/products/amq[messaging], link:#{site.base_url}/products/brms[business rules engines], link:#{site.base_url}/products/bpmsuite[workflow and BPM] solutions, and of course a developer link:#{site.base_url}/products/devstudio[IDE].
--

[.large-8.columns.ov-img]
image:#{cdn(site.base_url + '/images/solutions/enterprisejava/solutions_illustrations_enterprise_java.png')}["Enterprise Java Icon"]
...
link:#{site.base_url}/enterprisejava/adoption/#accelerate[Learn more ...]
...
link:#{site.base_url}/enterprisejava/adoption/#integrate[Learn more ...]
...
link:#{site.base_url}/enterprisejava/adoption/#automate[Learn more ...]
