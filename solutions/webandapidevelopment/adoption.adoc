...
. Learn how to manage dependencies with link:#{site.base_url}/webandapidevelopment/learn/#!query=maven[Maven]

// * Using Angular and RESTFul services link:#{site.base_url}/webandapidevelopment/learn/#!sys_type=quickstart&query=Angular[Get Started]
...
* link:#{site.base_url}/webandapidevelopment/learn/#!query=REST[Get started] exposing a RESTFul API.
