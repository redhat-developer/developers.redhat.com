...
[.large-8.columns]
image:#{cdn(site.base_url + '/images/solutions/webandapidevelopment/solutions_illustrations_webapi_development.png')}["Web and APIs Development Icon"]
