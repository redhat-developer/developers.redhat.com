...
2.	Enter the following command to launch the GUI installer: `java -jar jboss-dv-installer-6.2.0.redhat-2.jar`
...
..  Click the tab Software/Update and select the JBoss Data Virtualization Development option and click Install
+
