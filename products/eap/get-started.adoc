...
* link:#{site.base_url}/products/eap/learn[See Quickstarts, Videos, and other Learning materials]
* link:#{site.base_url}/products/eap/buzz[Read about how other people are using JBoss EAP]
