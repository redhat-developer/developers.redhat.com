...
+
[.content-img]
image://static.jboss.org/rhd/pr/165/build/372/images/images_products_devstudio_devstudio-overview-1-1.png[Add Maven Repository]
d.  Click Finish +
+
[.content-img]
image://static.jboss.org/rhd/pr/165/build/372/images/images_products_devstudio_devstudio-overview-2-1.png[Configure Maven Repository]
