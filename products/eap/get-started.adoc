...
Oracle JDK.
2.  Download link:#{site.download_manager_base_url}/download-manager/file/jboss-devstudio-9.1.0.GA-installer-eap.jar?tp=eap[JBoss Developer Studio 9.1.0.GA with EAP]
