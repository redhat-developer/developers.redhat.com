...
Note: When you use SSHFS, your home directory from the host system is automatically synchronized to your Vagrant box. For more information, see https://access.redhat.com/documentation/en/red-hat-container-development-kit/2.1/getting-started-guide/#synced-folders[Vagrant Synchronizad Folders] in the _CDK Getting Started Guide_. 
