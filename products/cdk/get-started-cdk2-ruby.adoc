...
Note: You can edit files on your host system and have them automatically synchronized to your Vagrant box using SSHFS. See https://access.redhat.com/documentation/en/red-hat-container-development-kit/2.1/getting-started-guide/#synced-folders[Vagrant Synchronizad Folders] in the _CDK Getting Started Guide_. 
