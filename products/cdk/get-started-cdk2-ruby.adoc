...
:title: "CDK 2.0 - Get started building Ruby 2.2 applications in docker containers"
:awestruct-description: "Get started building Ruby 2.2 applications in docker formatted containers using the Red Hat Container Development CDK (CDK) 2.0"
