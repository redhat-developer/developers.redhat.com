...
. Download the link:https://developers.redhat.com/download-manager/file/development-suite-1.0.0-GA-bundle-installer.exe[Red Hat Development Suite 1.0] installer
...
Download the https://developers.redhat.com/download-manager/file/cdk-2.0.0.zip[cdk-2.0.0.zip].
