...
* https://www.virtualbox.org/wiki/Downloads[VirtualBox, window='_blank'] (For Apple Mac OS X or Linux)
* Linux KVM/libvirt (For Red Hat Enterprise Linux, CentOS, or Fedora)

[.callout-light]
*NOTE:* If you are using Apple Mac OS X or a Linux distribution other than Red Hat, Fedora or CentOS, VirtualBox is recommended.
