...
[.callout-light]
*NOTE:* If you are using Microsoft Windows, Apple Mac OS X, or a Linux distribution other than Red Hat Enterprise Linux, Fedora, or CentOS, VirtualBox is recommended.
...
[.callout-light]
*NOTE:* Use Vagrant version 1.7.4 with VirtualBox on Microsoft Windows. Use version 1.8.1 and higher with Hyper-V. On Red Hat Enterprise Linux, use Vagrant 1.7.4.

If you are using:

* Microsoft Windows 7 and later, install Vagrant using the instructions in the https://access.redhat.com/documentation/en/red-hat-container-development-kit/2.1/installation-guide/#windows-add-sw[CDK Installation Guide, window='_blank'].
* Apple Mac OS X, install Vagrant using the instructions in the https://access.redhat.com/documentation/en/red-hat-container-development-kit/2.1/installation-guide/#mac-soft-install[CDK Installation Guide, window='_blank'].
...
* https://access.redhat.com/documentation/en/red-hat-container-development-kit/2.1/installation-guide/#installing_red_hat_container_development_kit_on_microsoft_windows[Installing CDK on Microsoft Windows, window='_blank']
