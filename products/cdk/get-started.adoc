...
. Download the link:#{site.download_manager_file_base_url}/download-manager/file/cdk/development-suite-1.0.0-GA-bundle-installer.exe[Red Hat Development Suite 1.0] installer
