...
2.  Download link:#{site.download_manager_base_url}/download-manager/file/devstudio-10.3.0.GA-installer-eap.jar[JBoss Developer Studio 10.3.0.GA with JBoss EAP]
...
...  Right-click `devstudio-10.3.0.GA-installer-eap.jar`
...
+
----
$ java -jar devstudio-10.3.0.GA-installer-eap.jar
----
+
