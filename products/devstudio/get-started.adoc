...
2.  Download link:#{site.download_manager_base_url}/download-manager/file/jboss-devstudio-9.1.0.GA-installer-eap.jar[JBoss Developer Studio 10.0.0.GA with JBoss EAP]
