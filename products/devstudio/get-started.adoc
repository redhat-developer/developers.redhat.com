...
2.  Download link:#{site.download_manager_base_url}/download-manager/file/devstudio-10.1.0.GA-installer-eap.jar[JBoss Developer Studio 10.1.0.GA with JBoss EAP]
...
...  Right-click `devstudio-10.1.0.GA-installer-eap.jar`
...
+
----
$ java -jar devstudio-10.1.0.GA-installer-eap.jar
----
+
...
* link:#{site.base_url}/products/devstudio/learn[See Quickstarts, Videos, and other Learning materials]
* link:#{site.base_url}/products/devstudio/buzz[Read about how other people are using DevStudio]
