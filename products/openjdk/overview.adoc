...
Run the downloaded https://developers.redhat.com/download-manager/file/java-1.8.0-openjdk-1.8.0.102-1-redhat.b14.windows.x86_64.msi[MSI-based installer] and follow the installation instructions on the screen.
