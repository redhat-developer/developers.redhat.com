...
3. You can now (optionally) install the Integration Stack for JBoss Developer Studio. This provides IDE support for developing JBoss BRMS applications. For more details, see the link:../../devstudio/adoption/#ExtraSection[installation instructions].
