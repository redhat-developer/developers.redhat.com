...
* link:#{site.base_url}/products/bpmsuite/developer-materials/#!projectCode=bpmsuite[Developer materials for JBoss BPM Suite]
* http://www.schabell.org/search/label/Tips%26Tricks[JBoss BPM Suite tips and tricks]
* link:#{site.base_url}/products/bpmsuite/developer-materials/#!formats=video&projectCode=bpmsuite[JBoss BPM Suite videos]
