...
This starters kit is currently targeting the product https://developers.redhat.com/download-manager/file/jboss-bpmsuite-6.1.0.GA-installer.jar[JBoss BPM Suite 6.1].
