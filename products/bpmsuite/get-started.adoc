...
The purpose of this kit is to provide the means to get started with the link:/products/bpmsuite/overview/[JBoss BPM Suite product], from introduction, to installation, to using the product to build a first application.
This kit will be setup to take a user from start to finish using the https://github.com/jbossdemocentral/bpms-rewards-demo[Red Hat JBoss BPM Suite - HR Employee Rewards Demo] as a PoC project.
...
* Installation and configuration of link:/products/bpmsuite/overview/[JBoss BPM Suite]
* Admin perspective
