...
3. You can now (optionally) install the Integration Stack for JBoss Developer Studio. This provides IDE support for developing JBoss BPM Suite applications. For more details, see the link:/products/devstudio/adoption/#ExtraSection[installation instructions].
