...
:title: "Software Collections - Get started developing with Ruby 2.2 on RHEL 7"
:awestruct-description: "Get started developing with Ruby 2.2 from Red Hat Software Collections on Red Hat Enterprise Linux 7 in under 10 minutes."
