...
:title: "Software Collections - Get started developing with Perl 5.20 on RHEL 7"
:awestruct-description: "Get started developing with Perl 5.20 from Red Hat Software Collections on Red Hat Enterprise Linux 7 in under 10 minutes."
