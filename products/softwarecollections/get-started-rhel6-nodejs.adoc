...
:title: "Software Collections - Get started developing with Node.js 0.10 on RHEL 6"
:awestruct-description: "Get started developing with Node.js 0.10 from Red Hat Software Collections on Red Hat Enerprise Linux 6 in under 10 minutes."
