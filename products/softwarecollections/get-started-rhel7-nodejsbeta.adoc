...
:title: "Software Collections Beta - Get started developing with Node.js v4.4 on RHEL 7"
:awestruct-description: "Get started developing with Node.js v4.4 from Red Hat Software Collections 2.2 Beta on Red Hat Enterprise Linux 7 in under 10 minutes."
