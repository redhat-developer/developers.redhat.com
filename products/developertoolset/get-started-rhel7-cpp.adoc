...
image:#{cdn(site.base_url + '/images/products/softwarecollections/rhel{tthw-rhelver}/manage-repositories.png')}[Manage Repositories]
...
image:#{cdn(site.base_url + '/images/products/developertoolset/rhel{tthw-rhelver}/eclipse-project.png')}[Eclipse Project]
