...
:title: "Developer Toolset - Get started developing with C++ and Eclipse on RHEL 7"
:awestruct-description: "Get started developing with C++ and Eclipse from Red Hat Developer Toolset on Red Hat Enterprise Linux 7"
