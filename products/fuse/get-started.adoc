...
Oracle JDK.
2.  Download link:#{download_manager_file_base_url}/jboss-devstudio-8.1.0.GA-jar_universal.jar?tp=fuse[JBoss Developer Studio 8.1.0.GA] 
...
1. Download link:#{download_manager_file_base_url}/jboss-fuse-6.2.1.GA-full_zip.zip[JBoss Fuse 6.2.1.GA]
+
*For Mac / Windows Development Hosts:*
+
