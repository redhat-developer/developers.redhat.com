...
:title: "Get started developing with Perl 5.16 on RHEL 7"
:awestruct-description: "Get started developing with Perl 5.16 on Red Hat Enterprise Linux 7 in under 10 minutes."
