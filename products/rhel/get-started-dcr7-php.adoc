...
:title: "Get started building PHP 5.6 applications in docker containers on RHEL 7"
:awestruct-description: "Get started building PHP 5.6 applications in docker containers on Red Hat Enterprise Linux 7 in under 15 minutes."
