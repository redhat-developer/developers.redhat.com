...
:title: "Get started developing with PHP 5.4 on RHEL 7"
:awestruct-description: "Get started developing with PHP 5.4 on Red Hat Enterprise Linux 7 in under 10 minutes."
