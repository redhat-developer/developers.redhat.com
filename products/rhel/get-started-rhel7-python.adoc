...
:title: "Get started developing with Python 2.7 on RHEL 7"
:awestruct-description: "Get started developing with Python 2.7 on Red Hat Enterprise Linux 7 in under 10 minutes."
