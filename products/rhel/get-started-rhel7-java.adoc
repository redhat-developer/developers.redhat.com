...
* Dive into Java enterprise application development with link:https://developers.redhat.com/ticket-monster/[Ticket Monster], a moderately complex application that demonstrates how to build modern applications using JBoss web technologies.
+
* Go to the Red Hat Developers site, to learn more about link:https://developers.redhat.com/enterprise-java/[Enterprise Java and JBoss technologies].
...
+
JBoss Developer Studio is built on Eclipse, it provides superior support for your entire development lifecycle. It includes features that will help you quickly get started developing Java applications. For development purposes, $0 subscriptions are available after registering at link:https://developers.redhat.com/[developers.redhat.com]
+
For more information see link:https://developers.redhat.com/products/devstudio/overview/[JBoss Developer Studio Overview].
+
