...
:title: "Get started developing with C++ on RHEL 6"
:awestruct-description: "Get started developing with C++ using GCC 4.4 on Red Hat Enterprise Linux 7 in under 10 minutes."
