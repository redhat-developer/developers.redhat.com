...
:title: "Get started developing with Ruby 1.8 on RHEL 6"
:awestruct-description: "Get started developing with Ruby 1.8 on Red Hat Enterprise Linux 6 in under 10 minutes."
...
link:http://developers.redhat.com/blog/[]
...
+
There were a number of differences in the Ruby language between version 1.8 and 1.9 that require code changes. Many Ruby gems needed to be updated for 1.9 and later. If you'd prefer to use a later version of Ruby, Red Hat Software Collections provides Ruby 2.3 for Red Hat Enterprise Linux 6 and 7.
