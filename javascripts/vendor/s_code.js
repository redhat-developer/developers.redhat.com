 ...
 */
 ...
 s.prop10 = s.eVar20 = "redhat.com/j/s_code.js | H.25.4";

 // User Agent Tracking
 s.prop44 = s.eVar44 = "D=User-Agent";

 // URL Tracking
  s.prop21 = s.eVar18 = (window.location.hostname + window.location.pathname).replace(/\/$/,"").toLowerCase();
