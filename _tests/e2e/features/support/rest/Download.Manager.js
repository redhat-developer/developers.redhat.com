...
class DownloadManager {
    ...
    constructor(baseUrl) {
        if (baseUrl === 'https://developers.stage.redhat.com') {
            this.baseUrl = 'https://developers.stage.redhat.com/download-manager/rest/available'
        } else {
            this.baseUrl = 'https://developers.redhat.com/download-manager/rest/available'
        }
    }
