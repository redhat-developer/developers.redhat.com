...
class GetMail {
    ...
    _searchForEmail(emailAddress) {
        ...
        while (email === null && checkCount < 30);
    ...
    _search(emailAddress) {
        ...
        let emails = await(this.imapConnection_.search([['UNSEEN'], ['TO', emailAddress]], fetchOptions));
    ...
    _getEmailBody(email) {
        ...
        let content = await(this.imapConnection_.getPartData(
            email, emailParts[0]
        ));
