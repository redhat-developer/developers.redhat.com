...
if (typeof process.env.RHD_TEST_PROFILE !== 'undefined') {
    kcReportDirectory = `keycloak/${process.env.RHD_TEST_PROFILE}/results`
} else {
    kcReportDirectory = 'keycloak/results'
}
...
exports.config = {
    ...
    screenshotPath: `${kcReportDirectory}/errorShots`,
    //
