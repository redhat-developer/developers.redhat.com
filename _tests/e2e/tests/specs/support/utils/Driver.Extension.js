...
export default class Driver {
    ...
    static awaitElementContainingText(selector, text) {
        return browser.waitUntil(function() {
            return selector.getText().indexOf(text) > -1;
        }, DEFAULT_TIMEOUT, `Timed out after ${DEFAULT_TIMEOUT} seconds waiting for element to contain ${text}`);
    }
