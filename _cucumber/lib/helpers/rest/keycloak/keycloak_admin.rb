# this class contains a set of methods that use the KeyCloak Admin service to generate and manipulate test data (Staging ONLY)
class KeyCloakAdmin
  ...
  def register_new_user
    @account_details = {
        enabled: true,
        emailVerified: true,
        attributes: { company: [@company_name], country: [@country], pwd: [@password], phoneNumber: [@phone_number], 'tcacc-1246' => ['y'], 'tcacc-1010' => ['y'], 'tcacc-6' => ['y'] },
        requiredActions: [],
        username: @email,
        email: @email,
  ...
  def user_with_missing_phone_number
    @account_details = {
        enabled: true,
        emailVerified: true,
        attributes: { company: [@company_name], country: [@country], pwd: [@password], 'tcacc-1246' => ['y'], 'tcacc-1010' => ['y'], 'tcacc-6' => ['y'] },
        requiredActions: [],
        username: @email,
        email: @email,
        firstName: @first_name,
    ...
    {
        email: @email,
        username: @email.tr('@redhat.com', '').tr('+', '-').tr('_', ''),
        password: @password,
        first_name: @first_name,
        last_name: @last_name,
        full_name: @full_name,
