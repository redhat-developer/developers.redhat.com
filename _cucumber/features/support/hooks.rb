...
def user_logout
  if Capybara.app_host.include?('docker')
    ...
    visit("#{Capybara.app_host.gsub('http', 'https')}/auth/realms/rhd/protocol/openid-connect/logout?redirect_uri=#{@redirect_url}%3Fredirect_fragment%3D!")
  end
